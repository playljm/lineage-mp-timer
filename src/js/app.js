        ...
        try {
          ...
          const report = {
            ...
            autoDetect: {
              ...
              // [v1.4.0] 자동 모드 정보
              mode: autoDetect.mode || 'manual',
              gameRegion: autoDetect.gameRegion || null,
              cachedROIs: autoDetect.cachedROIs ? {
                anchors: autoDetect.cachedROIs.anchors || null,
                textROIs: autoDetect.cachedROIs.textROIs || null,
                detectedAt: autoDetect.cachedROIs.detectedAt || 0,
                ageSeconds: autoDetect.cachedROIs.detectedAt ? Math.floor((Date.now() - autoDetect.cachedROIs.detectedAt) / 1000) : null,
                frameSize: autoDetect.cachedROIs.frameSize || null,
                valid: autoDetect.cachedROIs.valid !== false,
                issues: autoDetect.cachedROIs.issues || [],
              } : null,
              roiCacheMaxAge: autoDetect.roiCacheMaxAge || 300,
              roiFailThreshold: autoDetect.roiFailThreshold || 5,
